...
![Notes from Gitter](images/2018-04-15_12-06-07.png)

## How do I use JS libraries?

## Problems building the Fable samples
I needed to update the .paket executable in order to build the Fable samples.

### What are the parts?

* Libraries are specified in webpack.config.js.  How is that part of the system?  And they are in the module.exports.externals section.
* In the App.fs module, the code opens the Fable.Core.JsInterop module.  In the module, there are two functions
```
importDefault
importAll
```
These functions are contained in the Fable.Core.JsInterop.fs file
```fsharp
